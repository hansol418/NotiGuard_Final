...
POTENS_API_URL=https://ai.potens.ai/v1/chat/completions
RESPONSE_TIMEOUT=30
```
...
railway variables set POTENS_API_URL=https://ai.potens.ai/v1/chat/completions
...
5. **환경변수 추가**
   ...
   변수명: POTENS_API_URL
   값: https://ai.potens.ai/v1/chat/completions
